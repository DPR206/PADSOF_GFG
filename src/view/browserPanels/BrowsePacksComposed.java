...
public class BrowsePacksComposed extends AbstractMixedBrowserP<Pack, StoreProduct> {
    ...
    public void addFirstMiniPanel(Pack item, int index) throws BadLocationException {
        PackMiniP miniPack = new PackMiniP(item, index, "DELETE", ".\\resources\\app\\cart.png");
    ...
    public void addSecondMiniPanel(StoreProduct item, int index) throws BadLocationException {
        StoreProductMiniP miniPack = new StoreProductMiniP(item, index, "DELETE", ".\\resources\\app\\cart.png");
