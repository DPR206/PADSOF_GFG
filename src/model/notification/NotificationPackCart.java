...
/**
 * It implements the cart notification for packs
 * @author Duna P.R.
 * @version 1.3
 * @see Notification
...
public class NotificationPackCart extends Notification implements NotificationInterface<Pack>, Serializable {
	 ...
	 */
	public NotificationPackCart(LocalDateTime timeReceived, boolean read, boolean visible, NotificationType type) {
		super(timeReceived, read, visible, type);
	}

	/**
	 * Creates a new cart notification for packs with default timeMade (this moment)
	 *
	 ...
	 * @param type the type of notification
	 */
	public NotificationPackCart(String title, String text, LocalDateTime timeReceived, boolean read, boolean visible, NotificationType type) {
		super(title, text, timeReceived, read, visible, type);
	}

	/**
	 * Creates a new cart notification for packs
	 *
	 * @param title the tile of the notification
	 * @param text the message in the notification
	 ...
	 * @param type the type of notification
	 */
	public NotificationPackCart(String title, String text, LocalDateTime timeMade, LocalDateTime timeReceived, boolean read,
	 ...
	 */
	public String FullNotification(Pack o) {
		String text = "The pack " + o.getPrintInfo() + " in your cart have expired after " + Parameter.getParam().getOrderTime()
	 ...
	 */
	public String SnippetNotification(Pack o) {
