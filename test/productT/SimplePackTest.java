...
public class SimplePackTest {
    ...
    public void testAddProduct() {
        Comic comicExtra =
                new Comic("3", 10.0, "Extra", "Desc", "img.png", 5.0, LocalDate.now(), 10, 100, Year.of(2021), "Autor",
                        "Ed");
    ...
    @BeforeEach
    public void setUp() {
        comic = new Comic("1", 12.99, "alo", "algo2", "foto.png", 4.5, LocalDate.now(), 50, 120, Year.of(2020),
                "Juan Pérez", "ñe");
        Comic comic2 =
                new Comic("0", 12.99, "alo2", "algo2", "foto2.png", 43.5, LocalDate.now(), 50, 120, Year.of(2020),
                        "Juan Pérez", "awa");
