...
public class SecondHandProduct extends Product implements Serializable {
    ...
    public SecondHandProduct(double estimatedPrice, String name, String description, String photo, ProductType type,
                             LocalDate valuationDate, boolean available, boolean paidValuation,
                             ConservationStatus status, RegisteredClient owner
     ...
     * @param owner,         the owner of the product
     */
    public SecondHandProduct(String name, String description, String photo, ProductType type, boolean available,
                             boolean paidValuation, ConservationStatus status, RegisteredClient owner) {
    ...
    public void payValuation()
        ...
        Statistics.getINSTANCE()
                  .addRevenue((Double) Parameter.getParam().getValuationCost(), RevenueType.VALUATION, LocalDate.now(),
