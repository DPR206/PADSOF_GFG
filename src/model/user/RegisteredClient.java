...
public class RegisteredClient extends User implements Serializable {
    ...
    public RegisteredClient(UserType type, String pwd, String userName, String actualID, boolean asc,
                            ...
                            OrderHistory orderHistory, OfferHistory offerHistory,
                            NotificationHistory notificationHistory, Searcher searcher, int numOrders,
                            int numExchanges) {
    ...
    public void requestValuation(SecondHandProduct sp) {
        ...
        NotificationEmployeeValuation notification = new NotificationEmployeeValuation(LocalDateTime.now(), false, true,
